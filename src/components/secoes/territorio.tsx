      ...
      <div className="mv-shell relative mt-[var(--secao)] overflow-hidden">
        ...
        <div className="relative flex max-w-[68ch] flex-col gap-4 text-center sm:text-left">
          ...
          <p className="text-[1.0625rem] leading-relaxed text-fraca sm:text-[1.15rem]">
            Na geometria e no mapa, o triângulo é a estrutura mais firme que existe: ele não
            cede à pressão, ele distribui a força. É exatamente essa resistência que une os
            nossos nove municípios. Dividimos o mesmo litoral, a mesma serra, as mesmas
            potências e os mesmos desafios.
          </p>
          <p className="hidden text-[1.0625rem] leading-relaxed text-fraca sm:block sm:text-[1.15rem]">
            O triângulo não é figura de linguagem; ele fecha no mapa e sustenta a força do
            nosso povo. Mas para transformar essa união em prosperidade, essa região precisa
            de um novo olhar: planejamento integrado, valorização do trabalhador local e
            investimentos que fiquem aqui.
          </p>
        </div>
      </div>
